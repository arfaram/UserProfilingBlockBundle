 ...
 */
namespace Ez\UserProfilingBlockBundle\Controller;

use Ez\UserProfilingBlockBundle\Entity\UserPreferences;
use Ez\UserProfilingBlockBundle\Form\Type\UserPreferencesType;
...
class UserProfileController
{
    ...
    /** @var \EzSystems\StudioDemoBundle\User\UserInterests */
     ...
     * @param \EzSystems\StudioDemoBundle\User\UserInterests $userInterests
     */
    ...
    public function showPreferencesAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return new RedirectResponse($this->router->generate('user_preferences'));
        }

        return $this->templating->renderResponse('EzUserProfilingBlockBundle:user:preferences.html.twig', [

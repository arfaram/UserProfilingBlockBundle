...
class UserProfilingBlock extends AbstractBlockType
{
    ...
    public function createBlockDefinition()
    {
        return new BlockDefinition(
            ...
            'User Profiling',
            'default',
            'bundles/ezuserprofilingblock/images/userprofiling-block.svg',
            [],
            [
     ...
     * @param object $attributes
     *
     * @return \Ez\UserProfilingBlockBundle\Block\Model\TagItem[] $items
     */
     ...
     * @param \Ez\UserProfilingBlockBundle\Block\ItemCollection $itemCollection
     */
     ...
     *
     * @param \Ez\UserProfilingBlockBundle\Block\ItemCollection $input
     *
     * @return array
     */
